...
public class AppointmentDao {
	...
	public boolean addAppointment(Appointment ap) {
		...
		try {
			String sql = "insert into appointment (user_id,full_name,gender,age,appoint_date,email,phone_no,disease,doctor_id,address,status) values (?,?,?,?,?,?,?,?,?,?,?)";
